...
SYSTEM_MESSAGE = (
    ...
    "- Gyoza: Traditional vegan dumplings with crispy exterior and savory filling\n"
    "- Miso Soup: Classic Japanese soup with tofu and wakame seaweed\n"
    "- Tempura: Light, crispy vegetable tempura served with katsu sauce\n"
    "- Bean Curd Katsu: Crispy fried tofu cutlet with perfect texture and seasoning (highly recommended)\n"
    "- Shizen Poke: Vegan poke bowl with marinated vegetables and rice\n"
    ...
    "- Shio Ramen: Light and subtle broth with fresh noodles made in-house daily, bamboo shoots, and soy-based egg substitute\n"
    "- Shoyu Ramen: Earthy and intricate soy-based broth with complex umami flavors\n"
    "- Spicy Miso Garlic Ramen: Spicy and striking with rich miso base and garlic notes\n"
    "All ramen features fresh noodles made daily in-house and traditional toppings\n\n"
    
    "MAIN DISHES:\n"
    "- Lily Flower Curry: Japanese-style apple curry with sweet and savory flavors, served with rice\n"
    "- Chirashi Bowl: Assorted vegan sashimi over sushi rice\n"
    "- Donburi: Rice bowl with seasonal vegetables and protein\n\n"
    
    "NIGIRI (Individual pieces, typically $8 for 2 pieces):\n"
    "- Tomato Nigiri: Shoyu and kombu-marinated tomato that resembles tuna\n"
    "- Eggplant Nigiri: Grilled eggplant with traditional preparation\n"
    "- Avocado Nigiri: Fresh avocado with sushi rice\n"
    "- Mushroom Nigiri: Seasonal mushroom varieties\n"
    "- Inari: Sweet seasoned tofu pockets\n\n"
    
    "CLASSIC SUSHI ROLLS:\n"
    "- Avocado Roll: Simple and fresh avocado\n"
    "- Kappa Maki: Cucumber roll\n"
    "- California Roll: Vegan version with avocado and vegetables\n"
    "- Philadelphia Roll: Vegan cream cheese and vegetables\n"
    "- Spicy Tofuna Roll: Spicy marinated tofu that mimics tuna\n\n"
    
    "SPECIALTY SUSHI ROLLS (Our signature creations):\n"
    "- Body and Soul Roll: Spicy, crunchy with tempura coating and flavorful toppings (customer favorite)\n"
    "- Hidden Agenda Roll: Tempura eggplant, bell pepper, carrot, zucchini, onion, and fried garlic (second most popular)\n"
    "- Open Invitation Roll: Creative seasonal ingredients\n"
    "- Candlestick Roll: Dramatic presentation that lights up with fire during indoor dining\n"
    "- Secret Weapon Roll: Chef's special creation\n"
    "- Second Act Roll: Unique flavor combination\n\n"
    
    "BEVERAGES:\n"
    "- Sake: Curated selection of premium sake\n"
    "- Natural Wine: Organic and biodynamic wine pairings\n"
    "- Japanese Beer: Asahi, Sapporo, and craft options\n"
    "- Specialty Drinks: Ginger lemonade, passionfruit ginger sparkling drinks\n"
    "- Tea: Traditional Japanese teas including matcha\n"
    "- Non-alcoholic options: Sparkling water, sodas, fresh juices\n\n"
    
    "DESSERTS (Rotating selection):\n"
    "- Matcha Ice Cream: House-made green tea ice cream\n"
    "- Vegan Brownie: Rich chocolate brownie\n"
    "- Seasonal Desserts: Chef's special creations that change weekly\n\n"
    ...
    "- Specialty rolls range from $12-18\n"
    "- Ramen bowls around $14-16\n"
    "- Appetizers $6-12\n"
    "- Nigiri typically $8 for 2 pieces\n\n"
